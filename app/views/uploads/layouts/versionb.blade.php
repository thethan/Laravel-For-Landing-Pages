...
<html>
  <head>
    ...
    <link href="<?php echo asset('assets/css/versionb.css') ;?>" rel="stylesheet">
	...
	<script type="text/javascript">
			$(document).ready(function() {
				...
				$('.iosSlider').iosSlider({
					...
					navPrevSelector: $('#sliderleftRight .prevSlide'),
					navNextSelector: $('#sliderleftRight .nextslide'),
					infiniteSlider: true,
  		...
  		<header class="row">  			
  			<div class="col-md-9">
  				<div class="col-md-1 col-xs-1" id='icon'></div>
					...
					<?php $school = ($slug !== 'recording-arts') ?  'The Los Angeles Film School' :  'The Los Angeles Recording School' ; echo $school; ?> &reg;
