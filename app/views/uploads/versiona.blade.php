  		...
  		<header class="row">  			
  			<div class="col-md-8">
  				<div class="col-md-1 col-xs-1" id='icon'></div>
                    ...
                    <img src="<?php echo asset('assets/img/'.$school); ?>" alt="Los Angesles Film School" height="" width="400"/>
  		...
  		<div class="row container"> 
  			<aside class="col-xs-12 col-sm-6 col-md-5 col-lg-4 pull-right" > 
					...
					<?php if($slug !== 'entertainment-business' || $slug !== 'entertainment-business-online' ){	?>
                      <div id="launchbox" class="col-md-12 col-xs-12 center-block hiddent-sm">
