...
<html>
  <head>
    ...
    <link href="<?php echo asset('assets/css/omnic.css') ;?>" rel="stylesheet">
   ...
   <div class = 'iosSlider row'>
  		...
  		<div class="row container"> 
			...
			<div class="row program">
                ...
                <div id="animation" class="col-md-12">
							<h2>{{ $block1_title }}</h2>
							<h3> 
									{{ $block1_subheading }}	
							</h3>
                      ...
                      <div id="film" class="col-md-12">
                       ...
                       <div id="game-production" class="col-md-12">
							<h2>{{ $block3_title }}</h2>
							<h3> 
									{{ $block3_subheading }}	
							</h3>
						...
						<div class="col-md-6 col-sm-12">
								<div id="computer-animation" class="col-md-12">
                                <h2>{{ $block4_title }}</h2>
                                <h3> 
                                        {{ $block4_subheading }}	
                                </h3>
								...
								<div id="entertainment-business" class="col-md-12">
                                <h2>{{ $block6_title }}</h2>
                                <h3> 
                                   {{ $block6_subheading }}	
                                </h3>
